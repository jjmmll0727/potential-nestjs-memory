...
exports.WsKorGateway = void 0;
const common_1 = require("@nestjs/common");
const websockets_1 = require("@nestjs/websockets");
const socket_io_1 = require("socket.io");
let WsKorGateway = class WsKorGateway {
    constructor(logger) {
        this.logger = logger;
    }
    afterInit(server) {
...
exports.WsKorGateway = WsKorGateway;
__decorate([
    (0, websockets_1.WebSocketServer)(),
    __metadata("design:type", typeof (_b = typeof socket_io_1.Server !== "undefined" && socket_io_1.Server) === "function" ? _b : Object)
], WsKorGateway.prototype, "wsServer", void 0);
__decorate([
    (0, websockets_1.SubscribeMessage)('pub-message-kor'),
    __param(0, (0, websockets_1.MessageBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], WsKorGateway.prototype, "subMessage", null);
__decorate([
    (0, websockets_1.SubscribeMessage)('sub-message-kor'),
    __param(0, (0, websockets_1.MessageBody)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], WsKorGateway.prototype, "pubMessage", null);
exports.WsKorGateway = WsKorGateway = __decorate([
